...
export default function RoDTEPMasterEntryTable() {
  ...
  const [rows, setRows] = useState([
    { id: 1, hsnCode: "1001", rate: "5%", country: "India" },
    { id: 2, hsnCode: "2002", rate: "7%", country: "USA" },
  ]);
      ...
      renderCell: (params) => (
        <Stack direction="row" spacing={1}>
          <Tooltip title="Edit">
            <IconButton
              onClick={() =>
                navigate(`/material/finance-RoDTEP-master-entry-form/edit/${params.row.id}`, {
                  state: params.row,
                })
              }
            >
      ...
      <Stack spacing={3}>
        <Box display="flex" justifyContent="flex-end">
          <Button
            ...
            onClick={() => navigate("/material/finance-RoDTEP-master-entry-form/add")}
          >
            New
          </Button>
        </Box>
