...
export default function QualityDefectTypeTable() {
  ...
  const [rows, setRows] = useState([
    { id: 1, defectCategory: "Surface", defectType: "Scratch", desc: "Minor surface scratch" },
    { id: 2, defectCategory: "Dimension", defectType: "Tolerance", desc: "Out of tolerance" },
  ]);
  ...
  const columns = [
    { field: "defectCategory", headerName: "Defect Category", flex: 1 },
