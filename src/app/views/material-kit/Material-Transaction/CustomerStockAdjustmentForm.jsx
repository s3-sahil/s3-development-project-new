...
export default function CustomerStockAdjustmentForm() {
  ...
  const handleSave = () => {
    ...
    alert("Customer Stock Adjustment Saved (UI Only)");
  };

  return (
    <Container maxWidth="xl">
      <Box className="breadcrumb">
        <Breadcrumb routeSegments={[{ name: "Material" }, { name: "Customer Stock Adjustment" }]} />
      </Box>
      ...
      <Box sx={{ background: "#fff", p: 3, borderRadius: 2 }}>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={6}>
            <TextField label="Serial No." name="serialNo" value={formData.serialNo} onChange={handleChange} size="small" fullWidth />
          </Grid>
        </Grid>
      </Box>
    </Container>
