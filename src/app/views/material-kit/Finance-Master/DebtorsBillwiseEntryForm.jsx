  ...
  return (
    <Container maxWidth="xl">
      <Box className="breadcrumb" mb={2}>
        <Breadcrumb routeSegments={[{ name: "FINANCE" }, { name: "Debtors Billwise Entry" }]} />
      </Box>

      <Box sx={{ p: 3, borderRadius: 2 }}>
        {/* Header */}
        <Box display="flex" justifyContent="space-between" mb={2} alignItems="center">
          <Typography variant="h5" fontWeight="bold">Debtors Billwise Entry</Typography>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={4}>
            <TextField select label="Voucher Type" size="small" fullWidth value={formData.voucherType} onChange={handleChange("voucherType")}>
