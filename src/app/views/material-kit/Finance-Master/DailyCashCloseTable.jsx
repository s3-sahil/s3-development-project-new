...
export default function DailyCashCloseTable() {
  const navigate = useNavigate();

  const [rows, setRows] = useState([
    { id: 1, documentType: "Cash Ledger", closingDate: "2026-03-05", status: "Closed" },
    { id: 2, documentType: "Sales Ledger", closingDate: "2026-03-05", status: "Open" },
  ]);
