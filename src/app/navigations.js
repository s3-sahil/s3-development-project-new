    ...
    children: [
      {
        ...
        children: [
          ...
          { name: "Leave Details", path: "/material/payroll-leave-details-table", icon: "arrow_forward" },
          { name: "Yearly Holiday Details", path: "/material/payroll-yearly-holiday-table", icon: "arrow_forward" },
          ...
          { name: "Grade Wise Payment Details", path: "/material/payroll-grade-wise-payment-details-table", icon: "arrow_forward" },
          ...
          { name: "Payroll Calculation", path: "/material/payroll-payroll-calculations-table", icon: "arrow_forward" },
        ]
      },
      {
        name: "Transaction",
    ...
    children: [
      {
        ...
        children: [
          ...
          { name: "HSN/SAC Master", path: "/material/material-HSN-table", icon: "arrow_forward" },
          { name: "Alternate Item Details", path: "/material/material-alternate-item-table", icon: "arrow_forward" },
          { name: "State Detail", path: "/material/material-state-detail-table", icon: "arrow_forward" },
          { name: "Country Detail", path: "/material/material-country-details-table", icon: "arrow_forward" },
          { name: "Supplier Detail", path: "/material/material-supplier-table", icon: "arrow_forward" },
          { name: "District Detail", path: "/material/material-district-details-table", icon: "arrow_forward" },
          { name: "Property Values", path: "/material/material-property-values-table", icon: "arrow_forward" },
          { name: "Categorywise Property Values", path: "/material/material-category-property-table", icon: "arrow_forward" },
          { name: "Machine Hour Rate Detail", path: "/material/material-machine-hour-rate-table", icon: "arrow_forward" },
          { name: "Item HSN Detail", path: "/material/material-item-HSN-table", icon: "arrow_forward" },
          { name: "Operation Detail", path: "/material/material-operation-details-table", icon: "arrow_forward" },
          { name: "GST Detail", path: "/material/material-GST-detail-table", icon: "arrow_forward" },
          { name: "Exchange Currency Master", path: "/material/material-exchange-currency-table", icon: "arrow_forward" },
          { name: "Product Movement Flow", path: "/material/material-product-movement-table", icon: "arrow_forward" },
          { name: "Payement Conditions Detail", path: "/material/material-payment-conditions-table", icon: "arrow_forward" },
          { name: "SAC Group Master", path: "/material/material-SAC-group-table", icon: "arrow_forward" },
          { name: "Material Defect Detail", path: "/material/material-material-defect-table", icon: "arrow_forward" },
          { name: "Physical Inventory", path: "/material/material-physical-inventory-table", icon: "arrow_forward" },
          { name: "Item Detail", path: "/material/material-item-details-table", icon: "arrow_forward" },
          { name: "Bill Of Material", path: "/material/material-GRN-wise-opening-stock-table", icon: "arrow_forward" },
          { name: "Grade Master Details", path: "/material/material-grade-master-table", icon: "arrow_forward" },
          { name: "Itemwise Material Grade Detail", path: "/material/material-GRN-wise-opening-stock-table", icon: "arrow_forward" },
          { name: "Project Detail", path: "/material/material-project-detail-table", icon: "arrow_forward" },
          { name: "Inspection Parameter", path: "/material/material-GRN-wise-opening-stock-table", icon: "arrow_forward" },
          { name: "Item Inspection Parameter Details", path: "/material/material-item-inspection-table", icon: "arrow_forward" },
        ]
      },
      {
        name: "Transaction",
